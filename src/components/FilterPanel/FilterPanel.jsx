  ...
  return (
    <div>
          ...
          categories.map((item, index) => (
            <S.CategoryItem key={index}>
              <NavLink
                ...
                className={query?.category === item._id ? 'actived' : ''}
              >
                {item.name}
              </NavLink>
            </S.CategoryItem>
      ...
      <S.FilterGroup>
        ...
        <S.PriceRange>
          ...
          {Object.values(errors).length !== 0 && (
            <S.PriceErrorMessage>Vui long điền khoảng giá phù hợp</S.PriceErrorMessage>
          )}
          <S.PriceRangeButton type="submit" onClick={handleSubmit(searchPrice)}>
            Áp dụng
          </S.PriceRangeButton>
        </S.PriceRange>
      </S.FilterGroup>
      <S.FilterGroup>
        ...
        <RatingStars filters={filters}></RatingStars>
      </S.FilterGroup>
