  ...
  return (
    <div>
      <S.ProductQuantityController>
        <S.ProductQuantityButton onClick={() => !disabled && decrease()} disabled={disabled}>
        ...
        <S.ProductQuantityInput onBlur={handleBlur} disabled={disabled} value={value} onChange={handleChange} />
        <S.ProductQuantityButton onClick={() => !disabled && increase()} disabled={disabled}>
          <svg
